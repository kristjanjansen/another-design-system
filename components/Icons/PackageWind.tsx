...
function SvgPackageWind(props: IconProps) {
    return (
        <SvgWrapper
        ...
        >
            <defs>
                <style>{'.package-wind_svg__d{fill:#34b233}'}</style>
            </defs>
            <g id="package-wind_svg__b">
                <g id="package-wind_svg__c">
                    <path
